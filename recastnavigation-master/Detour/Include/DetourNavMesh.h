...
// Q ztj added
// 这个结构到底是做什么的呢???? bounding volume node ，aabb盒子
// 多边形包围的几何体吗?
...
struct dtMeshTile
{
	...
	// Q ztj added
	// verts是tile的顶点信息
	// detailVerts是将tile的大多三角形细分为小三角线的顶点数据。
	/// The detail mesh's unique vertices. [(x, y, z) * dtMeshHeader::detailVertCount]
	float* detailVerts;	

	// Q ztj added，上述detailVerts组合的三角形数据
